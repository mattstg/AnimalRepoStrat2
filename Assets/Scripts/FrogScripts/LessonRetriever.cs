...
public class LessonRetriever  {
    ...
    private string RetFrogLesson(int lessonNumber)
    {
        ...
        {
            case 0:
                return "In this game, you will play as a <b>male spadefoot toad</b>. Spadefoot toads live in arid places, and spend much of their time hibernating underground. When a heavy rainfall occurs, the toads emerge and seek out puddles of rainwater. When they find water, the male toads begin producing their mating calls. By the time the females arrive, there can be thousands of toads assembled around single pools of water. For one night, the toads engage in what is known as <i>explosive breeding</i>.";
            case 1:
            ...
            case 2:
                return "You have just found a fresh puddle following a rare desert thunderstorm. Many other toads have also arrived. But beware: the noisy toads have attracted some hungry predators! The more living descendants you have when the puddle dries up, the higher your score will be.";
            case 3:
                return "Spadefoot toads are considered an opportunistic <i>r</i>-species. They have large amounts of offspring, but few survive. They have short life expectancy, and their young mature very quickly. They do not protect their offspring, but rather focus on having as many as possible. That way, it is very likely that at least some of them will reach adulthood. A male spadefoot toad who does not take full advantage of the rare explosive breeding event is likely to have far fewer descendants than his rivals. ";
            default:
                Debug.Log("Lesson out of bounds " + lessonNumber);
                return "";
        }
    ...
    private string RetFishLesson(int lessonNumber)
    {
        ...
        {
        case 0: //intro1
			return "In this game, you will play as a <b>pacific salmon</b>. Salmon are hatched in freshwater rivers, but they eventually make their way out to the saltwater ocean, where they will spend most of their lives. Once they reach sexual maturity, they engage in one of nature’s spectacular events: the <i>salmon run</i>. Each year, millions of salmon return to the rivers where they were born, and swim hundreds of kilometers upstream to the pools where they spawned. Along the way, many are caught by predators (especially grizzly bears).";
		case 1://intro2
		...
		case 2://intro3
       	...
       	case 3://outro1
			return "Like spadefoot toads, salmon are considered <i>r</i>-selected species. They give birth to huge amounts of young, and provide no parental care. The run up the river itself serves as a selection process for salmon. Only those that can survive the difficult, dangerous journey up to the spawning grounds get to mate and pass on their genes. For a salmon, completing the run safely is the secret to successful mating. ";
		case 4://outro2
    ...
    private string RetCaribouLesson(int lessonNumber)
    {
        ...
        {
            case 0:  //1
			return "In this game, you will play as a <b>female barren-ground caribou</b>. Barren-ground caribou migrate each year from northern tundra in the summer to taiga forests to the south in winter. They travel in groups of up to fifty. They mate during their migration to the south, and females give birth to a single calf about seven months later. Some caribou migrate further than any other land mammal, walking up to five-thousand kilometers in a single year! Calves tend to reach maturity at around two years old. Fewer than half make it that far. ";
            case 1: //2
