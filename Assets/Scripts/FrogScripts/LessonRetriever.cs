...
public class LessonRetriever  {
    ...
    private string RetFrogLesson(int lessonNumber)
    {
        switch (lessonNumber)
        {
            ...
            case 2://intro3
				return "You have just found a group of fresh puddles following a rare desert thunderstorm. Many other toads have also arrived. But beware: the noisy toads have attracted some hungry predators!\nThe more living descendants you have when the puddles dry up, the higher your score will be.";
            case 3://outro1
